...
You might have seen an aquarium. Let us try to design one. What are the things that we need to keep in mind when we create an aquarium? The fish would need a free space for swimming (it could be a large jar), water, oxygen and food.   
We can provide oxygen through an oxygen pump (aerator) and fish food which is available in the market. If we add a few aquatic plants and animals it can become a selfsustaining system. Can you think how this happens? An aquarium is an example of a human-made ecosystem.   
...
When green plants are eaten by primary consumers, a great deal of energy is lost as heat to the environment, some amount goes into digestion and in doing work and the rest goes towards growth and reproduction. An average of $1 0 \%$ of the food eaten is turned into its own body and made available for the next level of consumers.

  
Figure 13.2 Trophic levels

Therefore, $1 0 \%$ can be taken as the average value for the amount of organic matter that is present at each step and reaches the next level of consumers.
...
What are trophic levels? Give an example of a food chain and state the different trophic levels in it. 2. What is the role of decomposers in the ecosystem?
...
Ozone $\mathrm { ( O _ { 3 } ) }$ is a molecule formed by three atoms of oxygen. While $\mathrm { { O } } _ { 2 }$ which we normally refer to as oxygen, is essential for all aerobic forms of life. Ozone, is a deadly poison. However, at the higher levels of the atmosphere, ozone performs an essential function. It shields the surface of the earth from ultraviolet (UV) radiation from the Sun. This radiation is highly damaging to organisms, for example, it is known to cause skin cancer in human beings.

Ozone at the higher levels of the atmosphere is a product of UV radiation acting on oxygen $\mathrm { ( O _ { 2 } ) }$ molecule. The higher energy UV radiations split apart some moleculer oxygen $\mathrm { ( O _ { 2 } ) }$ into free oxygen (0) atoms. These atoms then combine with the molecular oxygen to form ozone as shown—

$$
\begin{array} { r } { \mathrm { O } _ { 2 } \xrightarrow { \mathrm { U V } } \mathrm { O } + \mathrm { O } } \\ { \mathrm { O } + \mathrm { O } _ { 2 } \xrightarrow { } \mathrm { O } _ { 3 } } \\ { \mathrm { \Gamma } ( \mathrm { O z o n e } ) } \end{array}
$$
...
Find out from the library, internet or newspaper reports, which chemicals are responsible for the depletion of the ozone layer. Find out if the regulations put in place to control the emission of these chemicals have succeeded in reducing the damage to the ozone layer. Has the size of the hole in the ozone layer changed in recent years?
...
Bury this material in a pit in the school garden or if there is no space available, you can collect the material in an old bucket/ flower pot and cover with at least $1 5 ~ \mathrm { c m }$ of soil.   
...
1. What is ozone and how does it affect any ecosystem? 2. How can you help in reducing the problem of waste disposal? Give any two methods.

# What you have learnt

The various components of an ecosystem are interdependent.   
The producers make the energy from sunlight available to the rest of the ecosystem. There is a loss of energy as we go from one trophic level to the next, this limits the number of trophic levels in a food-chain.   
...
1Which of the following groups contain only biodegradable items?
...
(Walkig to school instead of getting your mother to drop you on her scooter   
(d) All of the above
...
What is biological magnification? Willthe levels of this magnification be different at different levels of the ecosystem?   
7What are the problems caused by the non-biodegradable wastes that we generate?   
