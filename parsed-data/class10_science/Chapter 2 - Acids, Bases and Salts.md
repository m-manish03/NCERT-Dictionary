...
# 2.1 UNDERSTANDING THE CHEMICAL PROPERTIES OFACIDS AND BASES

2.1.1 Acids and Bases in the Laboratory

# Activity 2.1

Collect the following solutions from the science laboratoryhydrochloric acid (HCh), sulphuric acid $\mathrm { ( H _ { 2 } S O _ { 4 } ) }$ , nitric acid $\mathrm { ( H N O _ { 3 } ) }$ , acetic acid $\mathrm { ( C H _ { 3 } C O O H ) }$ , sodium hydróxide (NaOH), calcium hydroxide $\mathrm { [ C a ( O H ) _ { 2 } ] }$ , potassium hydroxide (KOH), magnesium hydroxide $\mathrm { [ M g ( O H ) _ { 2 } ] }$ , and ammonium hydroxide $\mathrm { ( N H _ { 4 } O H ) }$ .   
Put a drop of each of the above solutions on a watch-glass one by one and test with a drop of the indicators shown in Table 2.1. What change in colour did you observe with red litmus, blue litmus, phenolphthalein and methyl orange solutions for each of the solutions taken?   
Tabulate your observations in Table 2.1.

Table 2.1   

<table><tr><td rowspan=1 colspan=1>Samplesolution</td><td rowspan=1 colspan=1>Redlitmussolution</td><td rowspan=1 colspan=1>Bluelitmussolution</td><td rowspan=1 colspan=1>Phenolph--thaleinsolution</td><td rowspan=1 colspan=1>Methylorangesolution</td></tr><tr><td rowspan=1 colspan=1></td><td rowspan=1 colspan=1></td><td rowspan=1 colspan=1></td><td rowspan=1 colspan=1></td><td rowspan=1 colspan=1></td></tr></table>
...
Keep them on a clean surface and put a few drops of dilute HCl solution on one strip and a few drops of dilute NaOH solution on the other. Rinse both cloth strips with water and again check their odour. Note your observations.   
...
Set the apparatus as shown in Fig. 2.1. Take about $5 ~ \mathrm { m L }$ of dilute sulphuric acid in a test tube and add a few pieces of zinc granules to it. What do you observe on the surface of zinc granules? Pass the gas being evolved through the soap solution. ub Why are bubbles formed in the soap solution? Take a burning candle near a gas filled bubble. What do you observe? Repeat this Activity with some more acids like HCl, $\mathrm { H N O } _ { 3 }$ and $\mathrm { C H _ { 3 } C O O H }$ .   
...
Place a few pieces of granulated zinc metal in a test tube. Add $2 \ \mathrm { m L }$ of sodium hydroxide solution and warm the contents of the test tube.   
...
$2 N a O H ( \mathrm { a q } ) + Z \mathrm { n ( s ) }  \mathrm { N a _ { 2 } Z n O _ { 2 } ( s ) } + \mathrm { H _ { 2 } ( g ) }$ (Sodium zincate)
...
Take about $0 . 5 \mathrm { g }$ of sodium carbonate $\mathrm { ( N a _ { 2 } C O _ { 3 } ) }$ in test tube A and about $0 . 5 \ \mathrm { g }$ of sodium hydrogencarbonate $\mathrm { ( N a H C O _ { 3 } ) }$ in test tube B.
...
Test tube A: $\mathrm { N a _ { 2 } C O _ { 3 } ( s ) + 2 H C l ( a q )  2 N a C l ( a q ) + H _ { 2 } O ( l ) + C O _ { 2 } ( g ) }$ Test tube B: $\mathrm { N a H C O _ { 3 } ( s ) + H C l ( a q )  N a C l ( a q ) + H _ { 2 } O ( l ) + C O _ { 2 } ( g ) }$

On passing the carbon dioxide gas evolved through lime water, $\mathrm { C a ( O H ) _ { 2 } ( a q ) + C O _ { 2 } ( g ) \to C a C O _ { 3 } ( s ) + H _ { 2 } O ( l ) }$ (Lime water) (White precipitate)

On passing excess carbon dioxide the following reaction takes place:

$$
\mathrm { C a C O _ { 3 } ( s ) + H _ { 2 } O ( l ) + C O _ { 2 } ( g )  C a ( H C O _ { 3 } ) _ { 2 } ( a q ) }
$$
...
Take about $2 \ \mathrm { m L }$ of dilute NaOH solution in a test tube and add two drops of phenolphthalein solution.   
What is the colour of the solution?   
Add dilute HCl solution to the above solution drop by drop. Is there any colour change for the reaction mixture?   
...
$$
\mathrm { N a O H ( a q ) } + \mathrm { H C l ( a q ) }  \mathrm { N a C l ( a q ) } + \mathrm { H _ { 2 } O ( l ) }
$$
...
Fix two nails on a cork, and place the cork in a $1 0 0 ~ \mathrm { { m L } }$ beaker.   
...
Acids contain $\mathrm { H ^ { + } }$ ion as cation and anion such as $\mathrm { C l ^ { - } }$ in HCl, $\mathrm { N O } _ { 3 } ^ { - }$ in $\mathrm { H N O } _ { 3 }$ , $\mathrm { S O _ { 4 } ^ { 2 - } }$ in $\mathrm { H } _ { 2 } \mathrm { S O } _ { 4 }$ , $\mathrm { C H _ { 3 } C O O ^ { - } }$ in $\mathrm { C H _ { 3 } C O O H }$ . Since the cation present in acids is $\mathrm { H ^ { + } }$ , this suggests that acids produce hydrogen ions, $\mathrm { H } ^ { + } ( \mathrm { a q } )$ , in solution, which are responsible for their acidic properties.
...
On the basis of the above Activity, what do you infer about the acidic character of: (i) dry HCl gas   
(ii) HCl solution?
...
$$
\mathrm { H C l } + \mathrm { H } _ { 2 } \mathrm { O }  \mathrm { H } _ { 3 } \mathrm { O } ^ { + } + \mathrm { C l } ^ { - }
$$

Hydrogen ions cannot exist alone, but they exist after combining with water molecules. Thus hydrogen ions must always be shown as $\mathrm { H } ^ { + } ( \mathrm { a q } )$ or hydronium ion $\mathrm { ( H _ { 3 } O ^ { + } ) }$ .

$$
\mathrm { H } ^ { + } + \mathrm { H } _ { 2 } \mathrm { O }  \mathrm { H } _ { 3 } \mathrm { O } ^ { + }
$$
...
$$
\mathrm { N a O H ( s ) \xrightarrow { H _ { 2 } O } \Delta  N a ^ { + } ( a q ) + O H ^ { - } ( a q ) }
$$

$$
\begin{array} { r l } & { \mathrm { K O H ( s ) } \xrightarrow { \mathrm { H } _ { 2 } \mathrm { O } } \mathrm { K } ^ { + } ( \mathrm { a q } ) + \mathrm { O H } ^ { - } \left( \mathrm { a q } \right) } \\ & { \mathrm { M g ( O H ) } _ { 2 } \mathrm { ( s ) } \xrightarrow { \mathrm { H } _ { 2 } \mathrm { O } } \quad \mathrm { M g } ^ { 2 + } ( \mathrm { a q } ) + 2 \mathrm { O H } ^ { - } ( \mathrm { a q } ) } \end{array}
$$
...
Now as we have identified that all acids generate $\mathrm { H } ^ { + } ( \mathrm { a q } )$ and all bases generate $\mathrm { O H } \bar { ( \mathrm { a q ) } }$ , we can view the neutralisation reaction as follows

  
Figure 2.5 Warning sign displayed on containers containing concentrated acids and bases

$$
\begin{array} { r l } & { \mathrm { A c i d } + \mathrm { B a s e }  \mathrm { S a l t } + \mathrm { W a t e r } } \\ & { \mathrm { H } [ \mathrm { X } + \mathrm { M } ] \mathrm { O H }  \mathrm { M X } + \mathrm { H O H } } \\ & { \mathrm { H } ^ { + } ( \mathrm { a q } ) + \mathrm { O H } ^ { - } ( \mathrm { a q } )  \mathrm { H } _ { 2 } \mathrm { O } ( \mathrm { l } ) } \end{array}
$$
...
Take $1 0 ~ \mathrm { m L }$ water in a beaker.   
...
Mixing an acid or base with water results in decrease in the concentration of ions $\mathrm { ( H _ { 3 } O ^ { + } / O H ^ { - } ) }$ per unit volume. Such a process is called dilution and the acid or the base is said to be diluted.

# QUESTIONS

Why do HCl, ${ \mathrm { H N O } } _ { 3 } ,$ etc., show acidic characters in aqueous solutions while solutions of compounds like alcohol and glucose do not show acidic character?   
...
5. How is the concentration of hydronium ions $\mathrm { ( H _ { 3 } O ^ { + } ) }$ affected when a solution of an acid is diluted?   
...
We know how acid-base indicators can be used to distinguish between an acid and a base. We have also learnt in the previous section about dilution and decrease in concentration of $\mathrm { H ^ { + } }$ or OH- ions in solutions. Can we quantitatively find the amount of these ions present in a solution? Can we judge how strong a given acid or base is?
...
Figure 2.6 Variation of $\mathrm { p H }$ with the change in concentration of $\mathrm { H } ^ { + } ( \mathrm { a q } )$ and OH-(aq) ions
...
Put about $_ { \textrm { 2 g } }$ soil in a test tube and add $5 ~ \mathrm { m L }$ water to it.   
...
<table><tr><td rowspan=1 colspan=1>Natural source</td><td rowspan=1 colspan=1>Acid</td><td rowspan=1 colspan=1>Natural source</td><td rowspan=1 colspan=1>Acid</td></tr><tr><td rowspan=1 colspan=1>Vinegar</td><td rowspan=1 colspan=1>Acetic acid</td><td rowspan=1 colspan=1>Sour milk (Curd)</td><td rowspan=1 colspan=1>Lactic acid</td></tr><tr><td rowspan=1 colspan=1>Orange</td><td rowspan=1 colspan=1>Citric acid</td><td rowspan=1 colspan=1>Lemon</td><td rowspan=1 colspan=1>Citric acid</td></tr><tr><td rowspan=1 colspan=1>Tamarind</td><td rowspan=1 colspan=1>Tartaric acid</td><td rowspan=1 colspan=1>Ant sting</td><td rowspan=1 colspan=1>Methanoic acid</td></tr><tr><td rowspan=1 colspan=1>Tomato</td><td rowspan=1 colspan=1>Oxalic acid</td><td rowspan=1 colspan=1>Nettle sting</td><td rowspan=1 colspan=1>Methanoic acid</td></tr></table>
...
2. What effect does the concentration of $\mathrm { H } ^ { + } ( \mathrm { a q } )$ ions have on the nature of the solution?   
...
Salts having the same positive or negative radicals are said to belong to a family. For example, NaCi and $\mathrm { N a } _ { 2 } \mathrm { S O } _ { 4 }$ belong to the family of sodium salts. Similarly, NaCl and KCl belong to the family of chloride salts. How many families can you identify among the salts given in this Activity?
...
<table><tr><td rowspan=1 colspan=1>Salt</td><td rowspan=1 colspan=1>pH</td><td rowspan=1 colspan=1>Acid used</td><td rowspan=1 colspan=1>Base used</td></tr><tr><td rowspan=1 colspan=1></td><td rowspan=1 colspan=1></td><td rowspan=1 colspan=1></td><td rowspan=1 colspan=1></td></tr></table>
...
$$
2 \mathrm { N a C l ( a q ) } + 2 \mathrm { H } _ { 2 } \mathrm { O ( l ) }  2 \mathrm { N a O H ( a q ) } + \mathrm { C l } _ { 2 } \mathrm { ( g ) } + \mathrm { H } _ { 2 } \mathrm { ( g ) }
$$
...
The baking soda is commonly used in the kitchen for making tasty crispy pakoras, etc. Sometimes it is added for faster cooking. The chemical name of the compound is sodium hydrogencarbonate $\mathrm { ( N a H C O _ { 3 } ) }$ . It is produced using sodium chloride as one of the raw materials.

$$
\begin{array} { r } { \mathrm { N a C l + H _ { 2 } O + C O _ { 2 } + N H _ { 3 }  N H _ { 4 } C l ~ + ~ N a H C O _ { 3 } } } \\ { \mathrm { ( A m m o n i u m ~ ( S o d i u m ~ } } \\ { \mathrm { c h l o r i d e ) } } \end{array}
$$
...
$2 \mathrm { N a H C O _ { 3 } } \xrightarrow { \mathrm { H e a t } } \mathrm { N a _ { 2 } C O _ { 3 } } + \mathrm { H _ { 2 } O } + \mathrm { C O _ { 2 } }$ (Sodium (Sodium hydrogencarbonate) carbonate)
...
$\begin{array} { r l } { \mathrm { N a H C O _ { 3 } } + \mathrm { H ^ { + } } } & { { }  \quad \mathrm { C O _ { 2 } } + \mathrm { H _ { 2 } O } + \downarrow } \end{array}$ Sodium salt of acid (From any acid)
...
Another chemical that can be obtained from sodium chloride is $\mathrm { N a } _ { 2 } \mathrm { C O } _ { 3 }$ . $\boldsymbol { 1 0 \mathrm { H } _ { 2 } \mathrm { O } }$ (washing soda). You have seen above that sodium carbonate can be obtained by heating baking soda; recrystallisation of sodium carbonate gives washing soda. It is also a basic salt.

$\mathrm { N a _ { 2 } C O _ { 3 } + 1 0 H _ { 2 } O  N a _ { 2 } C O _ { 3 } . 1 0 H _ { 2 } O }$   
(Sodium   
carbonate)

What does $\mathrm { 1 0 H _ { 2 } O }$ signify? Does it make $\mathrm { N a } _ { 2 } \mathrm { C O } _ { 3 }$ wet? We will address this question in the next section.
...
Water of crystallisation is the fixed number of water molecules present in one formula unit of a salt. Five water molecules are present in one formula unit of copper sulphate. Chemical formula for hydrated copper sulphate is Cu ${ \mathsf { S O } } _ { 4 }$ . $\mathrm { 5 H } _ { 2 } \mathrm { O }$ Now you would be able to answer the question whether the molecule of $\mathrm { N a _ { 2 } C O _ { 3 } . 1 0 H _ { 2 } O }$ is wet.

One other salt, which possesses water of crystallisation is gypsum. It has two water molecules as water of cyrstallisation. It has the chemical formula $\mathrm { C a S O _ { 4 } . 2 H _ { 2 } O }$ Let us look into the use of this salt.

# Plaster of Paris

On heating gypsum at $3 7 3 \ \mathrm { K }$ , it loses water molecules and becomes calcium sulphate hemihydrate (CaSO4 $\mathrm { ( C a S O _ { 4 } } \cdot \frac { 1 } { 2 } \mathrm { H } _ { 2 } \mathrm { O } )$ This is calld Plaster of
...
$\mathrm { C a S O } _ { 4 } \cdot \frac { 1 } { 2 } \mathrm { \ H } _ { 2 } \mathrm { O } + 1 \frac { 1 } { 2 } \mathrm { H } _ { 2 } \mathrm { O }  \mathrm { C a S O } _ { 4 } . 2 \mathrm { H } _ { 2 } \mathrm { O }$ (Plaster of Paris) (Gypsum)
...
1. What is the common name of the compound $\mathrm { C a ( C l O ) _ { 2 } ? }$   
...
A neutral solution has a pH of exactly 7, while an acidic solution has a pH less than 7 and a basic solution a $\mathrm { p H }$ more than 7.
...
3. $1 0 ~ \mathrm { m L }$ of a solution of NaOH is found to be completely neutralised by $8 ~ \mathrm { m L }$ of a given solution of HCl. If we take $2 0 \mathrm { m L }$ of the same solution of NaOH, the amount HCl solution (the same solution as before) required to neutralise it will be

(a) $4 \mathrm { m L }$ (b) 8 mL (c) 12 mL (d) 16 mL
...
adilute sulphuric acid reacts with zinc granules.   
...
() neutral? strongly alkaline? (c) strongly acidic? (d) weakly acidic? (e) weakly alkaline?

Arrange the pH in increasing order of hydrogen-ion concentration.

10.Equal lengths of magnesium ribbons are taken in test tubes A and B. Hydrochloric acid (HCl) is added to test tube A, while acetic acid $\mathrm { \small { ~ [ C H _ { 3 } C O O H ) } }$ is added to test tube B. Amount and concentration taken for both the acids are same. In which test tube will the fizzing occur more vigorously and why?

11. Fresh milk has a pH of 6. How do you think the $\mathrm { p H }$ will change as it turns into curd? Explain your answer.
...
Arrange four test tubes in a test tube stand and label them as A,B,C and D. Pour $2 \mathrm { m L }$ each of lemon juice solution, soda-water, vinegar and baking soda solution in them respectively.   
...
Take $2 0 \mathrm { m L }$ of sodium hydrogencarbonate $\mathrm { ( N a H C O _ { 3 } ) }$ solution in a wash-bottle. Suspend an ignition tube containing dilute sulphuric acid in the wash-bottle (Fig. 2.10).   
