...
Make a list of ten things you have used or consumed since the morning. Compile this list with the lists made by your classmates and then sort the items into the adjacent Table. If there are items which are made up of more than one material, put them into both the relevant columns of the table.

<table><tr><td rowspan=1 colspan=1>Thingsmadeof:metal</td><td rowspan=1 colspan=1>Thingsmadeofglass/clay</td><td rowspan=1 colspan=1>Others</td></tr><tr><td></td><td></td><td rowspan=1 colspan=1></td></tr></table>
...
<table><tr><td>Compound</td><td>Melting point (K)</td><td>Boiling point (K)</td></tr><tr><td>Acetic acid (CHCOOH)</td><td>290</td><td>391</td></tr><tr><td>Chloroform (CHC1)</td><td>209</td><td>334</td></tr><tr><td>Ethanol (CHCH2OH)</td><td>156</td><td>351</td></tr><tr><td>Methane (CH)</td><td>90</td><td>111</td></tr></table>
...
We have already seen the structure of methane. Another compound formed between carbon and hydrogen is ethane with a formula of $\mathrm { C _ { 2 } H _ { 6 } }$ .
...
However, another compound of carbon and hydrogen has the formula $\mathrm { C _ { 2 } H _ { 4 } }$ and is called ethene. How can this molecule be depicted? We follow the same step-wise approach as above.
...
<table><tr><td>No. of C atoms</td><td>Name</td><td>Formula</td><td>Structure</td></tr><tr><td>1</td><td>Methane</td><td>CH O od CERT</td><td>H</td></tr><tr><td>2</td><td>Ethane</td><td></td><td>H H --H H H</td></tr><tr><td>3</td><td>Propane</td><td></td><td>H H H H-C-C--H H H H</td></tr><tr><td>4</td><td>Butane</td><td>C4H10</td><td>H H H H H-----H H H H H</td></tr><tr><td>5</td><td></td><td>CgH1 12</td><td>HHHHH H---- C --H HHHHH</td></tr><tr><td>6</td><td>Hexane</td><td></td><td>H H H H H H H----- -C --H HHHHHH</td></tr></table>
...
Figure 4.8 (b) Complete molecules for two structures with formula $\mathrm { C _ { 4 } H } _ { 1 0 }$

We see that both these structures have the same formula $\mathrm { C _ { 4 } H } _ { 1 0 }$ Such compounds with identical molecular formula but different structures are called structural isomers.

In addition to straight and branched carbon chains, some compounds have carbon atoms arranged in the form of a ring. For example, cyclohexane has the formula $\mathrm { C _ { 6 } H _ { 1 2 } }$ and the following structure (

  
Figure 4.9 Structure of cyclohexane (a) carbon skeleton (b) complete molecule

Can you draw the electron dot structure for cyclohexane? Straight chain, branched chain and cyclic carbon compounds, all may be saturated or unsaturated. For example, benzene, $\mathrm { C _ { 6 } H _ { 6 } }$ has the following structure
...
<table><tr><td>Hetero atom</td><td>Class of compounds</td><td>Formula of functional group</td></tr><tr><td>Cl/Br</td><td>Halo- (Chloro/bromo) alkane</td><td>—Cl, —Br (substitutes for hydrogen atom)</td></tr><tr><td rowspan="2">Oxygen</td><td>1. Alcohol</td><td>—OH</td></tr><tr><td>2. Aldehyde</td><td></td></tr><tr><td rowspan="2"></td><td>3. Ketone</td><td>O</td></tr><tr><td>4. Carboxylic acid</td><td>C OH</td></tr></table>
...
$\mathrm { C H } _ { 4 }$ ${ \mathrm { C } } _ { 2 } { \mathrm { H } } _ { 6 }$ and and $\mathrm { C _ { 2 } H _ { 6 } }$ $\mathrm { C } _ { 3 } \mathrm { H } _ { 8 }$ these differ by a these differ by a $\mathrm { - C H _ { 2 } }$ $\mathrm { - C H _ { 2 } }$ unit unit

What is the difference between the next pair  propane and butane $\mathrm { ( C _ { 4 } H _ { 1 0 } ) ? }$

Can you find out the difference in molecular masses between these pairs (the atomic mass of carbon is $1 2 \mathrm { u }$ and the atomic mass of hydrogen is 1 u)?

Similarly, take the homologous series for alkenes. The first member of the series is ethene which we have already come across in Section 4.2.1. What is the formula for ethene? The succeeding members have the formula $\mathrm { C _ { 3 } H _ { 6 } }$ $\mathrm { { C _ { 4 } H _ { 8 } } }$ and $\mathrm { C } _ { 5 } \mathrm { H } _ { 1 0 }$ Do these also differ by a $\mathrm { - C H _ { 2 } - }$ unit? Do you see any relation between the number of carbon and hydrogen atoms in these compounds? The general formula for alkenes can be written as $\mathrm { C } _ { \mathrm { n } } \mathrm { H } _ { 2 \mathrm { n } }$ , where $\mathbf { n } = 2$ , 3, 4. Can you similarly generate the general formula for alkanes and alkynes?
...
Calculate the difference in the formulae and molecular masses for (a) $\mathrm { C H } _ { 3 } \mathrm { O H }$ and $\mathrm { C _ { 2 } H _ { 5 } O H }$ (b) $\mathrm { C _ { 2 } H _ { 5 } O H }$ and $\mathrm { C } _ { 3 } \mathrm { H } _ { 7 } \mathrm { O H }$ , and (c) $\mathrm { C _ { 3 } H _ { 7 } O H }$ and $\mathrm { C _ { 4 } H _ { 9 } O H }$ .
...
<table><tr><td rowspan=1 colspan=1>Class ofcompounds</td><td rowspan=1 colspan=1>Prefix/Suffix</td><td rowspan=1 colspan=1>Example</td></tr><tr><td rowspan=1 colspan=1>1. Halo alkane</td><td rowspan=1 colspan=1>Prefix-chloro,bromo, etc.</td><td rowspan=1 colspan=1>H H HH--C-C-Cl  ChloropropaneIH H H</td></tr><tr><td rowspan=1 colspan=1></td><td rowspan=1 colspan=1></td><td rowspan=1 colspan=1>H H HH----Br BromopropaneH H H</td></tr><tr><td rowspan=1 colspan=1>2. Alcohol</td><td rowspan=1 colspan=1>Suffix - ol</td><td rowspan=1 colspan=1>H H H             edH----OHPropanolIH H H</td></tr><tr><td rowspan=1 colspan=1>3. Aldehyde</td><td rowspan=1 colspan=1>Suffix - al</td><td rowspan=1 colspan=1>H H HH--C-C=O  PropanalH H</td></tr><tr><td rowspan=1 colspan=1>4. Ketone</td><td rowspan=1 colspan=1>Suffix - one</td><td rowspan=1 colspan=1>H     HH--C-C-H   PropanonelIH OH</td></tr><tr><td rowspan=1 colspan=1>5. Carboxylic acid</td><td rowspan=1 colspan=1>Suffix - oic acid</td><td rowspan=1 colspan=1>H H OIIH-C---OHPropanoic acid|H H</td></tr><tr><td rowspan=1 colspan=1>6. Alkenes</td><td rowspan=1 colspan=1>Suffix - ene</td><td rowspan=1 colspan=1>H HHH--=C        PropeneHH</td></tr><tr><td rowspan=1 colspan=1>7. Alkynes</td><td rowspan=1 colspan=1>Suffix - yne</td><td rowspan=1 colspan=1>HH-C-C=C-H   PropyneH</td></tr></table>

# QUESTIONS

1 How many structural isomers can you draw for pentane? 2. What are the two properties of carbon which lead to the huge number of carbon compounds we see around us? 3. What will be the formula and electron dot structure of cyclopentane?
...
(i) $\mathrm { ~ C ~ } + \mathrm { ~ O ~ } _ { 2 } \to \mathrm { C O } _ { 2 } +$ heat and light (ii) $\mathrm { C H } _ { 4 } + \mathrm { O } _ { 2 } \to \mathrm { C O } _ { 2 } + \mathrm { H } _ { 2 } \mathrm { O } +$ heat and light (iii) $\mathrm { C H } _ { 3 } \mathrm { C H } _ { 2 } \mathrm { O H } + \mathrm { O } _ { 2 } \to \mathrm { C O } _ { 2 } + \mathrm { H } _ { 2 } \mathrm { O } +$ heat and light
...
Place a metal plate above the flame. Is there a deposition on the plate in case of any of the compounds? Light a bunsen burner and adjust the air hole at the base to get different types of flames/presence of smoke. When ´do you get a yellow, sooty flame?   
...
Take about $3 \ \mathrm { m L }$ of ethanol in a test tube and warm it gently in a water bath.   
...
H H   
R R Nickel catalyst R C C R H2   
R R R R
...
Why is the conversion of ethanol to ethanoic acid an oxidation reaction? 2. A mixture of oxygen and ethyne is burnt for welding. Can you tell why a mixture of ethyne and air is not used?
...
# $2 \mathrm { N a } + 2 \mathrm { C H } _ { 3 } \mathrm { C H } _ { 2 } \mathrm { O H }  2 \mathrm { C H } _ { 3 } \mathrm { C H } _ { 2 } \mathrm { O } ^ { - } \mathrm { N a } ^ { + } + \mathrm { H } _ { 2 }$ (Sodium ethoxide)
...
(ii) Reaction to give unsaturated hydrocarbon: Heating ethanol at $4 4 3 \mathrm { ~ K ~ }$ with excess concentrated sulphuric acid results in the dehydration of ethanol to give ethene

$$
\mathrm { C H } _ { 3 } - \mathrm { C H } _ { 2 } \mathrm { O H } \frac { \mathrm { H o t } \mathrm { C o n c . } } { \mathrm { H } _ { 2 } \mathrm { S O } _ { 4 } }  \mathrm { C H } _ { 2 } = \mathrm { C H } _ { 2 } + \mathrm { H } _ { 2 } \mathrm { O }
$$
...
Take $1 \textrm { m L }$ ethanol (absolute alcohol) and $1 \textrm { m L }$ glacial acetic acid along with a few drops of concentrated sulphuric acid in a test tube. Warm in a water-bath for at least five minutes as shown in Fig. 4.11. Pour into a beaker containing $2 0 \mathrm { - } 5 0 \ \mathrm { \ m L }$ of water and smell the resulting mixture.
...
-COOH + CH3 CH2OH Acid CH C -O- CH2 - CH3 + H2O O
...
$$
\mathrm { N a O H + C H _ { 3 } C O O H  C H _ { 3 } C O O N a + H _ { 2 } O }
$$
...
What do you observe?   
Pass the gas produced through freshly prepared lime-water. What do you observe? Can the gas produced by the reaction between ethanoic acid and sodium carbonate be identified by this test?   
Repeat this Activity with sodium hydrogencarbonate instead of sodium carbonate.

(iii) Reaction with carbonates and hydrogencarbonates: Ethanoic acid reacts with carbonates and hydrogencarbonates to give rise to a salt, carbon dioxide and water. The salt produced is commonly called sodium acetate. $2 \mathrm { C H } _ { 3 } \mathrm { C O O H } + \mathrm { N a } _ { 2 } \mathrm { C O } _ { 3 }  2 \mathrm { C H } _ { 3 } \mathrm { C O O N a } + \mathrm { H } _ { 2 } \mathrm { O } + \mathrm { C O } _ { 2 }$ $\mathrm { C H } _ { 3 } \mathrm { C O O H } + \mathrm { N a H C O } _ { 3 }  \mathrm { C H } _ { 3 } \mathrm { C O O N a } + \mathrm { H } _ { 2 } \mathrm { O } + \mathrm { C O } _ { 2 }$
...
Take about $1 0 \mathrm { m L }$ of water each in two test tubes. Add a drop of oil (cooking oil) to both the test tubes and label them as A and B.   
...
Hydrophilic end Hydrophobic end O Soap molecu Hydrophilic end Na+ Hydrophobic end Grease or dirt e repub Z Na+ Na+
...
Take about $1 0 ~ \mathrm { m L }$ of distilled water (or rain water) and $1 0 ~ \mathrm { m L }$ of hard water (from a tubewell or hand-pump) in separate test tubes. Add a couple of drops of soap solution to both.   
...
Take two test tubes with about $1 0 ~ \mathrm { m L }$ of hard water in each. Add five drops of soap solution to one and five drops of detergent solution to the other.   
...
The ability of carbon to form chains gives rise to a homologous series of compounds in which the same functional group is attached to carbon chains of different lengths. The functional groups such as alcohols, aldehydes, ketones and carboxylic acids bestow characteristic properties to the carbon compounds that contain them. Carbon and its compounds are some of our major sources of fuels.   
Ethanol and ethanoic acid are carbon compounds of importance in our daily lives. The action of soaps and detergents is based on the presence of both hydrophobic and hydrophilic groups in the molecule and this helps to emulsify the oily dirt and hence its removal.

# EXERCISES

Ethane, with the molecular formula $\mathrm { C _ { 2 } H _ { 6 } }$ has
...
(a) ethanoic acid. (b) $\mathrm { H } _ { 2 } \mathrm { S }$ .   
(c) propanone.   
(d) $\mathrm { F } _ { 2 }$

6.What is an homologous series? Explain with an example.

7How can ethanol and ethanoic acid be differentiated on the basis of their physical and chemical properties?

8Why does micelle formation take place when soap is added to water? Will a micelle be formed in other solvents such as ethanol also?

9. Why are carbon and its compounds used as fuels for most applications?

0.Explain the formation of scum when hard water is treated with soap.

11.What change will you observe if you test soap with litmus paper (red and blue)?

12. What is hydrogenation? What is its industrial application?

13.Which of the following hydrocarbons undergo addition reactions: $\mathrm { C _ { 2 } H _ { 6 } }$ $\mathrm { C } _ { 3 } \mathrm { H } _ { 8 }$ $\mathrm { C _ { 3 } H _ { 6 } }$ $\mathrm { C } _ { 2 } \mathrm { H } _ { 2 }$ and $\mathrm { C H } _ { 4 }$ . C

14Give a test that can be used to differentiate between saturated and unsaturated hydrocarbons.

15. Explain the mechanism of the cleaning action of soaps.

# Group Activity

Use molecular model kits to make models of the compounds you have learnt in this Chapter.

Take about $2 0 ~ \mathrm { m L }$ of castor oil/cotton seed oil/linseed oil/soyabean oil in a beaker. Add $3 0 \mathrm { m L }$ of $2 0 \%$ sodium hydroxide solution. Heat the mixture with continuous stirring for a few minutes till the mixture thickens. Add $5 \mathrm { - } 1 0 \mathrm { g }$ of common salt to this. Stir the mixture well and allow it to cool.
