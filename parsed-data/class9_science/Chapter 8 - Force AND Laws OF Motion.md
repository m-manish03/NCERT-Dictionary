...
Fig. 8.1: Pushing, pulling, or hitting objects change their state of motion.
...
Galileo Galilei was born on 15 February 1564 in Pisa, Italy. Galileo, right from his childhood, had interest in mathematics and natural philosophy. But his father Vincenzo Galilei wanted him to become a medical doctor. Accordingly, Galileo enrolled himself for a medical degree at the

Galileo Galilei (1564- 1642)

University of Pisa in 1581 which he never completed because of his real interest in mathematics. In 1586, he wrote his first scientific book 'The Little Balance [La Balancittal', in which he described Archimedes' method of finding the relative densities (or specific gravities) of substances using a balance. In 1589, in his series of essays  De Motu, he presented his theories about falling objects using an inclined plane to slow down the rate of descent.

In 1592, he was appointed professor of mathematics at the University of Padua in the Republic of Venice. Here he continued his observations on the theory of motionand through his study of inclined planes and the pendulum, formulated the correct law for uniformly accelerated objects that the distance the object moves is proportional to the square of the time taken.
...
1. Which of the following has more inertia: (a) a rubber ball and a stone of the same size? (b) a bicycle and a train? (c) a fiverupees coin and a one-rupee coin?   
...
$$
\begin{array} { c } { { \boxed { F = \frac { k m \times ( v - u ) } { t } } } } \\ { { = k m a } } \end{array}
$$

Here a $\alpha = [ ( v - u ) / t ]$ is the acceleration, which is the rate of change of velocity. The quantity, $k$ is a constant of proportionality. The SI units of mass and acceleration are $\mathbf { k } \mathbf { g }$ and m $\mathbf { S } ^ { - 2 }$ respectively. The unit of force is so chosen that the value of the constant, $k$ becomes one. For this, one unit of force is defined as the amount that produces an acceleration of $1 \mathrm { m } \mathrm { s } ^ { - 2 }$ in an object of $1 \mathrm { k g }$ mass. That is,

$$
1 \ { \mathrm { u n i t ~ o f ~ f o r c e } } = k \times ( 1 \ { \mathrm { k g } } ) \times ( 1 \ { \mathrm { m } } \ { \mathrm { s } } ^ { - 2 } ) .
$$
...
$$
\begin{array} { l } { { \displaystyle F = m a } } \\ { ~ } \\ { { \displaystyle F = \frac { m \left( v - u \right) } { t } } } \\ { { \displaystyle F t = m v - m u } } \end{array}
$$

That is, when $F = 0 , \ V = u$ for whatever time, $t$ is taken. This means that the object will continue moving with uniform velocity, $_ { u }$ throughout the time, $t .$ If $_ { u }$ is zero then vwill also be zero. That is, the object will remain at rest.

Example 8.1 A constant force acts on an object of mass $5 ~ \mathrm { k g }$ for a duration of $2 \ \mathbf { s } .$ It increases the objects velocity from $3 \mathrm { ~ m ~ } \mathbf { s } ^ { - 1 }$ to $7 \textrm { m } \mathbf { s } ^ { - 1 }$ . Find the magnitude of the applied force. Now, if   
the force was applied for a duration of ${ \boldsymbol { 5 } } \thinspace \mathbf { s }$ ,what would be the final velocity of the object?

# Solution:

We have been given that $u = 3 \mathrm { ~ m ~ } \mathbf { s } ^ { - 1 }$ and $\nu = 7 \textnormal { m s } ^ { - 1 }$ , $t = 2$ s and $m = 5 \mathrm { k g }$ . From Eq. (8.5) we have,
...
$$
F = 5 \mathrm { ~ k g ~ } ( 7 \mathrm { ~ m ~ } \mathrm { s } ^ { - 1 } - 3 \mathrm { ~ m ~ } \mathrm { s } ^ { - 1 } ) / 2 \mathrm { ~ s } = 1 0 \mathrm { ~ N } .
$$
...
$$
\nu = 1 3 \mathrm { m } \mathrm { \bf s } ^ { - 1 }
$$

Example 8.2 Which would require a greater force — accelerating a $2 \mathrm { k g }$ mass at $5 \mathrm { m } \mathrm { s } ^ { - 2 }$ or a $4 \ : \mathrm { k g }$ mass at $2 \mathrm { m } \mathrm { \thinspace s ^ { - 2 } ? }$

# Solution:

From Eq. (8.4), we have $F = m a ,$ . Here we have $m _ { \scriptscriptstyle 1 } = 2 ~ \mathrm { k g }$ ; $a _ { \scriptscriptstyle 1 } = 5 \mathrm { ~ m ~ } \mathrm { s } ^ { \scriptscriptstyle - 2 }$ and $m _ { 2 } = 4$ kg; $a _ { _ 2 } = 2 \textrm { m s } ^ { - 2 }$ . Thus, $F _ { _ { I } } = m _ { _ { I } } a _ { _ { I } } = 2 \mathrm { ~ k g } \times 5 \mathrm { ~ m ~ s } ^ { - 2 } = 1 0 \mathrm { ~ N } ;$ and $F _ { _ 2 } \ = \ m _ { _ 2 } a _ { _ 2 } \ = 4 \ \mathrm { k g } \times 2 \ \mathrm { m } \ \mathrm { s } ^ { - 2 } = 8 \ \mathrm { N }$ $\Rightarrow F _ { 1 } > F _ { 2 } .$ Thus, accelerating a $2 \ \mathrm { k g }$ mass at $5 \textrm { m } \mathbf { s } ^ { - 2 }$ would require a greater force.

Example 8.3 A motorcar is moving with a velocity of $1 0 8 \mathrm { { k m / h } }$ and it takes $4 \thinspace \mathrm { s }$ to stop after the brakes are applied. Calculate the force exerted by the brakes on the motorcar if its mass along with the passengers is $1 0 0 0 \ \mathrm { k g } .$ .

# Solution:

The initial velocity of the motorcar $u = 1 0 8 \mathrm { { k m / h } }$ $= 1 0 8 \times 1 0 0 0 \mathrm { m } / ( 6 0 \times 6 0 \mathrm { s } )$ $= 3 0 \mathrm { ~ m ~ } \mathbf { s } ^ { - 1 }$ and the final velocity of the motorcar $v = 0 \mathrm { ~ m ~ } \mathbf { s } ^ { - 1 }$ .

The total mass of the motorcar along with its passengers $= 1 0 0 0 ~ \mathrm { k g }$ and the time taken to stop the motorcar, $t = 4 \ : \mathbf { S } .$ . From Eq. (8.5) we have the magnitude of the force $( F )$ applied by the brakes as $m ( v - u ) / t$ .
...
Example 8.4 A force of $5 \mathrm { ~ N ~ }$ gives a mass $m _ { \scriptscriptstyle 1 }$ ,an acceleration of $1 0  { \mathrm { ~ m ~ } }  { \mathbf { s } } ^ { - 2 }$ and a mass $m _ { 2 }$ ,an acceleration of $2 0 \textnormal { m s } ^ { 2 }$ . What acceleration would it give if both the masses were tied together?

# Solution:

From Eq. (8.4) we have $m _ { \scriptscriptstyle 1 } = F / a _ { \scriptscriptstyle 1 }$ ; and $m _ { 2 } = F / a _ { _ 2 }$ Here, $a _ { _ { I } } = 1 0 { \mathrm { ~ m ~ } } \mathbf { s } ^ { - 2 }$ ; $a _ { _ 2 } = 2 0 \textrm { m s ^ { - 2 } }$ and $F = 5 \mathrm { ~ N ~ }$ . Thus, $m _ { \scriptscriptstyle { 1 } } = 5 \mathrm { N } / 1 0 \mathrm { m } \mathrm { s } ^ { \scriptscriptstyle { - 2 } } = 0 . 5 0 \mathrm { k g } ;$ and $m _ { _ 2 } = 5 \mathrm { ~ N } / 2 0 \mathrm { ~ m ~ } \mathrm { s } ^ { - 2 } = 0 . 2 5 \mathrm { ~ k g ~ }$ . If the two masses were tied together, the total mass, $m$ would be $m = 0 . 5 0 \mathrm { ~ k g } + 0 . 2 5 \mathrm { ~ k g } = 0 . 7 5 \mathrm { ~ k g } .$ . The acceleration, $a$ produced in the combined mass by the $5 \mathrm { N }$ force would be, $a = F / m = 5 ~ \mathrm { N } / 0 . 7 5 ~ \mathrm { k g } = 6 . 6 7 ~ \mathrm { m } ~ \mathrm { s } ^ { - 2 }$ .

Example 8.5 The velocity-time graph of a ball of mass $2 0 \textrm { g }$ moving along a straight line on a long table is given in Fig. 8.9.
...
The initial velocity of the ball is $2 0 \mathrm { c m } \mathrm { \bf s } ^ { - 1 }$ . Due to the frictional force exerted by the table, the velocity of the ball decreases down to zero in $1 0 \thinspace \mathbf { s } .$ Thus, $u = 2 0 \thinspace \mathrm { c m \thinspace s ^ { - 1 } }$ ; $v = 0 \ \mathrm { c m \ } \mathbf { s } ^ { - 1 }$ and $t = 1 0 \mathrm { ~ s ~ }$ Since the velocity-time graph is a straight line, it is clear that the ball moves with a constant acceleration. The acceleration $a$ is

$$
\begin{array} { l } { \displaystyle a = \frac { v - u } { t } } \\ { \displaystyle \ } \\ { \displaystyle \ = ( 0 \mathrm { \ c m \ s ^ { - 1 } - 2 0 \ c m \ s ^ { - 1 } } ) / 1 0 \mathrm { \ s } } \\ { \displaystyle \ = - 2 \mathrm { \ c m \ s ^ { - 2 } = - 0 . 0 2 m \ s ^ { - 2 } } . } \end{array}
$$

The force exerted on the ball $F$ is, F = ma= (20/1000) $\mathbf { k g } \times \left( - 0 . 0 2 \mathrm { ~ m ~ } \mathbf { s } ^ { - 2 } \right)$ $= - 0 . 0 0 0 4 \mathrm { ~ N } .$ .
...
The cart shown in this activity can be constructed by using a $1 2 \mathrm { m m }$ or $1 8 \mathrm { m m }$ thick plywood board of about $5 0 \mathrm { c m } \times 1 0 0$ cm with two pairs of hard ball-bearing wheels (skate wheels are good to use). Skateboards are not as effective because it is difficult to maintain straight-line motion.

# What you have learnt

D First law of motion: An object continues to be in a state of rest or of uniform motion along a straight line unless acted upon by an unbalanced force. The natural tendency of objects to resist a change in their state of rest or of uniform motion is called inertia.   
. The mass of an object is a measure of its inertia. Its SI unit is kilogram (kg). Force of friction always opposes motion of objects. Second law of motion: The rate of change of momentum of an object is proportional to the applied unbalanced force in the direction of the force.   
• The SI unit of force is $\mathbf { k } \mathbf { g } \mathbf { \ m } \mathbf { \ s } ^ { - 2 }$ . This is also known as newton and represented by the symbol $_ \mathrm { N }$ A force of one newton produces an acceleration of $1  { \mathrm { ~ m ~ } }  { \mathbf { s } } ^ { - 2 }$ on an object of mass $1 ~ \mathrm { k g }$ .   
• The momentum of an object is the product of its mass and velocity and has the same direction as that of the velocity. Its SI unit is $\mathbf { k } \mathbf { g } \textbf { m } \mathbf { s } ^ { - 1 }$ .   
...
5. A truck starts from rest and rolls down a hill with a constant acceleration. It travels a distance of $4 0 0 \ \mathrm { m }$ in $2 0 \ \mathbf { s } .$ Find its acceleration. Find the force acting on it if its mass is 7 tonnes (Hint: 1 tonne $= 1 0 0 0 \ \mathrm { k g } .$   
6. A stone of $1 ~ \mathrm { k g }$ is thrown with a velocity of $2 0 \textnormal { m } \mathbf { s } ^ { - 1 }$ across the frozen surface of a lake and comes to rest after travelling a distance of $5 0 ~ \mathrm { m }$ .What is the force of friction between the stone and the ice?   
7. A $8 0 0 0 ~ \mathrm { k g }$ engine pulls a train of 5 wagons, each of $2 0 0 0 ~ \mathrm { k g }$ along a horizontal track. If the engine exerts a force of 40000 N and the track offers a friction force of $5 0 0 0 \mathrm { ~ N ~ }$ ,then calculate: (a) the net accelerating force and (b) the acceleration of the train.

8. An automobile vehicle has a mass of $1 5 0 0 ~ \mathrm { k g }$ What must be the force between the vehicle and road if the vehicle is to be stopped with a negative acceleration of $1 . 7 \mathrm { ~ m ~ s ^ { - 2 2 } }$

9. What is the momentum of an object of mass $m$ ,moving with a velocity $\boldsymbol { v ? }$

(a) $( m v ) ^ { 2 }$ $\mathrm { ( b ) } \ m v ^ { 2 } \qquad \mathrm { ( c ) } \ ^ { \mathrm { 1 } } / _ { 2 } \ m v ^ { 2 } \qquad \mathrm { ( d ) } \ m w$

10. Using a horizontal force of $2 0 0 \mathrm { N }$ , we intend to move a wooden cabinet across a floor at a constant velocity. What is the friction force that will be exerted on the cabinet?
...
12. A hockey ball of mass $2 0 0 ~ \mathrm { g }$ travelling at $1 0 \textnormal { m } \mathbf { s } ^ { - 1 }$ is struck by a hockey stick so as to return it along its original path with a velocity at $5 \mathrm { m } \mathrm { s } ^ { - 1 }$ . Calculate the magnitude of change of momentum occurred in the motion of the hockey ball by the force applied by the hockey stick.

13. A bullet of mass $1 0 \ \mathrm { g }$ travelling horizontally with a velocity of $1 5 0 \mathrm { ~ m ~ } \mathbf { s } ^ { - 1 }$ strikes a stationary wooden block and comes to rest in O.03 s. Calculate the distance of penetration of the bullet into the block. Also calculate the magnitude of the force exerted by the wooden block on the bullet.

14. An object of mass $1 \ \mathrm { k g }$ travelling in a straight line with a velocity of $1 0 \mathrm { ~ m ~ } \mathbf { s } ^ { - 1 }$ collides with, and sticks to, a stationary wooden block of mass $5 \mathrm { k g }$ Then they both move off together in the same straight line. Calculate the total momentum just before the impact and just after the impact. Also, calculate the velocity of the combined object.

15. An object of mass $1 0 0 ~ \mathrm { k g }$ is accelerated uniformly from a velocity of $5 \textrm { m } \mathbf { s } ^ { - 1 }$ to $8 \mathrm { ~ m ~ } \mathbf { S } ^ { - 1 }$ in 6 s. Calculate the initial and final momentum of the object. Also, find the magnitude of the force exerted on the object.
...
17. How much momentum will a dumb-bell of mass $1 0 ~ \mathrm { k g }$ transfer to the floor if it falls from a height of $8 0 ~ \mathrm { c m ? }$ Take its downward acceleration to be $1 0  { \mathrm { ~ m ~ } }  { \mathbf { s } } ^ { - 2 }$ .

# Additional Exercises

Al. The following is the distance-time table of an object in motion:
...
A2. Two persons manage to push a motorcar of mass $1 2 0 0 ~ \mathrm { k g }$ at a uniform velocity along a level road. The same motorcar can be pushed by three persons to produce an acceleration of $0 . 2 \mathrm { ~ m ~ } \mathbf { s } ^ { - 2 }$ With what force does each person push the motorcar? (Assume that all persons push the motorcar with the same muscular effort.)

A3. A hammer of mass $5 0 0 \ \mathrm { g }$ moving at $5 0 \textrm { m } \mathbf { s } ^ { - 1 }$ , strikes a nail. The nail stops the hammer in a very short time of $0 . 0 1 \textbf { s }$ . x What is the force of the nail on the hammer?

A4. A motorcar of mass $1 2 0 0 ~ \mathrm { k g }$ is moving along a straight line with a uniform velocity of $9 0 ~ \mathrm { k m / h }$ . Its velocity is slowed down to $1 8 \ \mathrm { k m / h }$ in 4 s by an unbalanced external force. Calculate the acceleration and change in momentum. Also calculate the magnitude of the force required.